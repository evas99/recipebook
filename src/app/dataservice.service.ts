...
export class DataserviceService {
  ...
  initDemoRecipes(){
    ...
    this.addNewRecipe(<Recipe> {name: "Apfelkuchen", img: imgString, description: descString, zutaten: demoZutaten });
    this.addNewRecipe(<Recipe> {name: "Erdbeerkuchen", img: img2, description: descString, zutaten: demoZutaten2 });
  }
