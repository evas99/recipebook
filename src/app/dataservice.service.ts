...
export class DataserviceService {
  ...
  private initDemoRecipes(){
    ...
    var descString = "Teig: Mehl, Fett, Zucker, Ei und Vanillezucker zu einem Teig verarbeiten und auf einem Blech verteilen. Ich benutze immer ein Obstkuchenblech, das ist etwas kleiner als das übliche Blech. Dann die Äpfel schälen, in Stücke schneiden und mit dem Apfelmus in einer Schüssel vermischen. Die Masse auf den Teig geben. Streusel: Das Fett im Topf schmelzen, vom Herd nehmen, die restlichen Zutaten vermischen und dazugeben. Diese Masse kurz abkühlen lassen und dann Streusel erzeugen, indem man Teig in die Hand nimmt und zwischen beiden Händen zerbröselt. Natürlich am besten über dem Kuchen auf dem Blech. Dann auf der mittleren Schiene bei ca. 175 Grad Heißluft ca. 45 Min. backen. Aber Vorsicht: Immer beobachten, da Streusel schnell verbrennen. Dazu passt Sahne oder auch mal Vanilleeis. Man kann auch auf die Apfelmasse gehackte Walnüsse o. ä. geben. Und darüber dann die Streusel.";
    var descStringErd = "Den Boden einer Springform mit Backpapier auslegen. Den Backofen auf 190°C vorheizen. Teig: Alle Zutaten mischen, in die Springform füllen und ca. 10-12 min backen. Abkühlen lassen. Aus der Form nehmen, das Backpapier entfernen. Den Boden umgekehrt wieder in die Form legen. Den Springformrand wieder darum legen. Die Erdbeeren in kleine Stückchen schneiden. Den Quark mit Zucker und Vanillezucker mischen. Die Sahne steif schlagen und zusammen mit der Gelatine und einer Handvoll Erdbeerstückchen unterheben. Masse auf den Boden geben und glatt streichen. Die restlichen Erdbeerstückchen darauf verteilen. Den Tortenguss nach Anleitung zubereiten, etwas abkühlen lassen und über den Erdbeeren verteilen. Eine Stunde in den Kühlschrank stellen.";
    ...
    this.addNewRecipe(<Recipe> {
      name: "Apfelkuchen", 
      img: imgString, 
      description: "Omas leckerer Apfelkuchen", 
      zubereitung: descString,
      zutaten: demoZutaten });
    this.addNewRecipe(<Recipe> {
      name: "Erdbeerkuchen", 
      img: img2, 
      description: "Omas leckerer Erdbeerkuchen", 
      zubereitung: descStringErd,
